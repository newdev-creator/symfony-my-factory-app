 ...
 */
final class Version20240525115852 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client ADD COLUMN is_archived INTEGER NOT NULL');
        $this->addSql('ALTER TABLE "order" ADD COLUMN is_archived INTEGER NOT NULL');
        $this->addSql('ALTER TABLE plan_and_schema ADD COLUMN is_archived INTEGER NOT NULL');
        $this->addSql('ALTER TABLE product ADD COLUMN is_archived INTEGER NOT NULL');
        $this->addSql('ALTER TABLE user ADD COLUMN is_archived INTEGER NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO product (id, plan_and_schema_id, name, description, unit_price, supplier, start_date, end_date, created_at, updated_at) SELECT id, plan_and_schema_id, name, description, unit_price, supplier, start_date, end_date, created_at, updated_at FROM __temp__product');
